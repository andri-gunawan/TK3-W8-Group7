...
<head>
    ...
    <meta name="description" content="TK3-W8 | Group 7">
    <meta name="author" content="Group 7">

    <!-- CSRF Token -->
    <meta name="csrf-token" content="{{ csrf_token() }}">

    <title>TK3-W8 | Group 7</title>
...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
            ...
            <div class="sidebar-brand-text mx-2">TK3 - Group 7</div>
        </a>
        ...
        <li class="nav-item {{ Nav::isRoute('dashboard') }}">
            <a class="nav-link pb-3" href="{{ route('dashboard') }}">
        ...
        <li class="nav-item {{ Nav::isRoute('profile') }}">
            <a class="nav-link pb-2" href="{{ route('profile') }}">
                <i class="fas fa-fw fa-user-shield"></i>
                <span>{{ __('Data Role') }}</span>
            </a>
        </li>

        <li class="nav-item {{ Nav::isRoute('profile') }}">
            <a class="nav-link pt-1" href="{{ route('profile') }}">
                <i class="fas fa-fw fa-users"></i>
                <span>{{ __('Data Pegawai') }}</span>
            </a>
        </li>
